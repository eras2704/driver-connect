...
const demo: PublicDriver = {
  ...
  photos: [],
  services: [
    { name: "Traslados al aeropuerto", icon: "plane", photoUrl: null, description: "Llegadas y salidas de Tocumen, coordinadas con tu itinerario. Tu viaje comienza con calma." },
    { name: "Traslados ejecutivos", icon: "briefcase", photoUrl: null, description: "Un conductor para tus reuniones, compromisos y recorridos de trabajo. Espacio para seguir con tu día." },
    { name: "Recorridos por la ciudad", icon: "compass", photoUrl: null, description: "Descubre Panamá a tu ritmo, con un recorrido privado y tiempo para disfrutar cada parada." },
  ],
